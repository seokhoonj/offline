...
install_packages <- function(packages) {
  if (missing(packages))
    ...
    , "e1071", "earth", "ecos", "epiR", "extrafont", "faraway", "fastAdaboost", "feather"
    ...
    , "keras", "kernlab", "kknn", "KMsurv", "kosis"
    ...
    , "survival", "survminer", "tensorflow", "testthat", "textclean", "tibble"
    , "tidybayes", "tidymodels", "tidyr", "tidytext", "tm", "topicmodels", "TraMineR"
    , "treemap", "truncreg", "tseries", "tweedie"
    , "utf8", "vars", "vcd", "VGAM", "VIM", "wordcloud"
