...
install_packages <- function(packages) {
  if (missing(packages))
    ...
    , "Boruta", "brms", "bslib", "calendR", "car", "caret", "caretEnsemble"
    , "caTools", "chemometrics", "circlize", "cluster", "compareGroups"
    , "corrplot"
    , "data.table", "DBI", "devtools", "DiagrammeR", "dplyr", "DT", "dygraphs"
    , "e1071", "earth", "epiR", "extrafont"
    , "faraway", "fastAdaboost", "feather", "forcats", "forecast", "foreign"
    , "formattable", "fortunes"
    , "gamlss", "gbm", "genridge", "ggalluvial", "gganimate", "ggbump", "ggdark"
    , "ggExtra", "ggfortify", "ggmap", "ggnetwork", "ggparliament", "ggplot2"
    , "ggridges", "ggstream", "ggthemes", "ggVennDiagram", "ggvoronoi"
    , "ggwordcloud", "glmnet", "gridExtra", "gvlma"
    ...
    , "reticulate", "Rfast", "rgl", "rglwidget", "ridge", "rintrojs", "rio"
    , "rJava", "rlang", "rmarkdown", "RMySQL", "ROCR", "RODBC", "roxygen2"
    , "rpart", "rpart.plot", "RSQLite", "rstudioapi"
    , "sampling", "scales", "scatterplot3d", "segmented"
    , "shiny", "shinybusy", "shinyBS", "shinycssloaders", "shinydashboard"
    , "shinyFiles", "shinyjs", "shinymanager"
    ...
    , "tidyr", "tidytext", "tm", "topicmodels", "TraMineR", "treemap"
    , "truncreg", "tseries", "tweedie"
    , "utf8"
    , "vars", "vcd", "VGAM", "VIM"
    , "wordcloud", "writexl"
